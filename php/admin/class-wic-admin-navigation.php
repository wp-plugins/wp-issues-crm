...
class WIC_Admin_Navigation {
	...
	*/
	...
	public function do_uploads () {
		...
		echo '<div class="wrap"><div id = "wp-issues-crm-full-screen"><h2>' . __( 'Upload Data', 'wp-issues-crm' ) . '</h2>';
	...
	public function do_fields () {
		...
		echo '<div class="wrap"><div id = "wp-issues-crm-full-screen"><h2>' . __( 'Customize Fields', 'wp-issues-crm' ) . '</h2>';
	...
	public function do_options () {
		...
		echo '<div class="wrap"><div id = "wp-issues-crm-full-screen"><h2>'  .__( 'Manage Option Groups', 'wp-issues-crm' ) . '</h2>';		
	...
	public function do_storage () {
		...
		echo '<div class="wrap"><div id = "wp-issues-crm-full-screen"><h2>'  .__( 'Manage Storage', 'wp-issues-crm' ) . '</h2>';		
